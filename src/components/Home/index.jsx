  ...
  return (
    ...
    >
        ...
        >
          ...
          <motion.div
            className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-0"
            variants={sectionVariants}
          >
            <div className="relative before:absolute before:left-6 sm:before:left-7 lg:before:left-8 before:top-0 before:bottom-0 before:w-0.5 before:bg-gradient-to-b from-green-500/40 to-transparent">
              <div className="ml-4 sm:ml-6 lg:ml-12 space-y-10 sm:space-y-12">
                {work.map((exp, index) => (
                  <motion.article
                    key={exp.title}
                    ...
                    whileHover={{ x: 6 }}
                  >
                    <div className="absolute left-0 top-6 sm:top-7 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-green-500 to-green-600 text-white shadow-glow flex items-center justify-center">
                      <span className="text-sm sm:text-base font-semibold">{String(index + 1).padStart(2, '0')}</span>
                    </div>
                    <div className="rounded-3xl border border-gray hover:border-gray-300/50 p-5 sm:p-6 lg:p-8 shadow-lg bg-white/80 backdrop-blur">
          ...
          <motion.div
            className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-0 pb-24"
            variants={sectionVariants}
          >
            <div className="relative before:absolute before:left-6 sm:before:left-7 lg:before:left-8 before:top-0 before:bottom-0 before:w-0.5 before:bg-gradient-to-b from-green-500/40 to-transparent">
              <div className="ml-4 sm:ml-6 lg:ml-12 space-y-10 sm:space-y-12">
